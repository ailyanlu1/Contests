...
int N, rating[MAXN];
OrderedRootArray<4, pii, OrderedRootArray<3, pii, OrderedSqrtArray<pii, greater<pii>>, greater<pii>>, greater<pii>> arr(4);
// OrderedRootArray<3, pii, OrderedSqrtArray<pii, greater<pii>>, greater<pii>> arr(4);
