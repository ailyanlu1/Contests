...
public class ORDERSET_Sqrt_Array {
    ...
    public static void run(int testCaseNum) throws Exception {
        ...
        for (int i = 0; i < Q; i++) {
            ...
            case 'D':
                ...
                break;
            case 'K':
                if (x > n) out.println("invalid");
                else out.println(get(x - 1));
                break;
            case 'C':
                out.println(getRank(x));
                break;
            default:
                i--;
                break;
