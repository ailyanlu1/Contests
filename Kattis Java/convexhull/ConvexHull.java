...
public class ConvexHull {
    ...
    public static class GrahamScanConvexHull {
        public ArrayList<Point2D> hull = new ArrayList<Point2D>();
    ...
    public static boolean run(int testCaseNum) throws Exception {
        ...
        GrahamScanConvexHull ch = new GrahamScanConvexHull(P);
        out.println(ch.hull.size());
        for (Point2D p : ch.hull) out.println((int) p.x() + " " + (int) p.y());
        return true;
    }
}
