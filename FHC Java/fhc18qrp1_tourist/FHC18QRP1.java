...
public class FHC18QRP1 {
    ...
    private static final String INPUT_FILE_NAME = "tourist.txt";
    private static final String OUTPUT_FILE_NAME = "tourist_out.txt";
    ...
    public static void run(int testCaseNum) throws Exception {
        int N = in.nextInt(), K = in.nextInt(), V = (int) ((in.nextLong() - 1) * K % N);
