...
public class FHC18QRP2 {
    ...
    private static final String INPUT_FILE_NAME = "interception.txt";
    private static final String OUTPUT_FILE_NAME = "interception_out.txt";
    ...
    public static void run(int testCaseNum) throws Exception {
        int N = in.nextInt();
        out.println("Case #" + testCaseNum + ": " + (N % 2 == 0 ? "0" : "1\n0.0"));
