...
int T, N, M, L[MAXNODES], R[MAXNODES], LZ[MAXNODES], VAL[MAXNODES], MX[MAXNODES], SUM[MAXNODES], PRE[MAXNODES], SUF[MAXNODES], MAXSUM[MAXNODES], SZ[MAXNODES], root = 0, curNode = 0;
bool REV[MAXNODES];
double PRI[MAXNODES];
char op[16];
