// http://codeforces.com/problemsets/acmsguru/problem/99999/111
import java.io.*;
import java.math.*;
import java.util.*;

public class SGU111 {
    private static SGU111 o = new SGU111();
    ...
    public static void run(int testCaseNum) throws Exception {
        ...
        while (lo.compareTo(hi) <= 0)  {
            mid = lo.add(hi).shiftRight(1);
            if (x.compareTo(mid.multiply(mid)) < 0) hi = mid.subtract(BigInteger.ONE);
