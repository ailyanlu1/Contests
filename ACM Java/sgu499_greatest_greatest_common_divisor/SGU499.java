// http://codeforces.com/problemsets/acmsguru/problem/99999/499
import java.io.*;
import java.math.*;
import java.util.*;

public class SGU499 {
    private static SGU499 o = new SGU499();
    ...
    static final int MAXVAL = 1000005;
    
    // TODO CODE GOES IN THIS METHOD
    public static void run(int testCaseNum) throws Exception {
        boolean[] has = new boolean[MAXVAL];
        for (int i = 0; i < MAXVAL; i++) has[i] = false;
        int N = in.nextInt();
        int maxVal = 0;
        for (int i = 0; i < N; i++) {
            int a = in.nextInt();
