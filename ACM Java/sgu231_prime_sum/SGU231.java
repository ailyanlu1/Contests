// http://codeforces.com/problemsets/acmsguru/problem/99999/231
import java.io.*;
import java.math.*;
import java.util.*;

public class SGU231 {
    private static SGU231 o = new SGU231();
    ...
    public static void run(int testCaseNum) throws Exception {
        ...
        for (int i = 0; i < primes.size() - 1; i++) if (primes.get(i) + 2 == primes.get(i + 1)) ans.add(i);
        out.println(ans.size());
        for (int i : ans) out.println(2 + " " + (primes.get(i)));
    }
