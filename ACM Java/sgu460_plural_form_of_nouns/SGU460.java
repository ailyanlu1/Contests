// http://codeforces.com/problemsets/acmsguru/problem/99999/460
import java.io.*;
import java.math.*;
import java.util.*;

public class SGU460 {
    private static SGU460 o = new SGU460();
    ...
    public static void run(int testCaseNum) throws Exception {
        ...
        for (int i = 0; i < N; i++) {
            String s = in.next();
            if (s.endsWith("ch") || s.endsWith("x") || s.endsWith("s") || s.endsWith("o")) out.println(s + "es");
            else if (s.endsWith("f")) out.println(s.substring(0, s.length() - 1) + "ves");
            else if (s.endsWith("fe")) out.println(s.substring(0, s.length() - 2) + "ves");
            else if (s.endsWith("y")) out.println(s.substring(0, s.length() - 1) + "ies");
