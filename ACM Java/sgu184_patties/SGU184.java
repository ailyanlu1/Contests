// http://codeforces.com/problemsets/acmsguru/problem/99999/184
import java.io.*;
import java.math.*;
import java.util.*;

public class SGU184 {
    private static SGU184 o = new SGU184();
    ...
    public static void run(int testCaseNum) throws Exception {
        int P = in.nextInt(), M = in.nextInt(), C = in.nextInt(), K = in.nextInt(), R = in.nextInt(), V = in.nextInt();
        out.println(Math.min(Math.min(P / K, M / R), C / V));
    }
}
