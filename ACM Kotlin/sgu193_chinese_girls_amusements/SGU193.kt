// http://codeforces.com/problemsets/acmsguru/problem/99999/193
import java.io.*
import java.math.*
import java.util.*
...
fun run(testCaseNum: Int) {
    val N = BigInteger(In.next())
    val TWO = BigInteger.ONE + BigInteger.ONE
    if (N % TWO == BigInteger.ZERO) Out.println(N / TWO / TWO * TWO - BigInteger.ONE)
    else Out.println(N / TWO)
}
