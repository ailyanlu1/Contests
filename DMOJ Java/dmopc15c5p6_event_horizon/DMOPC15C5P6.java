package dmopc15c5p6_event_horizon;
...
public class DMOPC15C5P6 {
    ...
    public class Digraph {
        ...
        private HashMap<Integer, Integer>[] adj;    // adj[v] = adjacency list for vertex v
        ...
        public Digraph(int V) {
            ...
            for (int v = 0; v < V; v++) {
                adj[v] = new HashMap<Integer, Integer>();
            }
        }
        ...
        public void addEdge(int v, int w) {
            ...
            else adj[v].put(w, adj[v].get(w) + 1);
        }
        
        public void removeEdge(int v, int w) {
            adj[v].put(w, adj[v].get(w) - 1);
            if (adj[v].get(w) == 0) {
                adj[v].remove(w);
                indegree[w]--;
                E--;
    ...
    */
    ...
    private static State dfs(int v) {
        State s = new State();
        s.min = count[v];
        vis[v] = true;
        for (int w: G.adj(v)) {
