...
fun run(testCaseNum: Int) {
    Out.println((IntArray(In.nextInt(), {In.nextInt()}).fold(0) { dot, x -> dot + x * In.nextInt() }).toString() + " " + (IntArray(In.nextInt(), {In.nextInt()}).fold(0) { dot, x -> dot + x * In.nextInt() }).toString())
}
